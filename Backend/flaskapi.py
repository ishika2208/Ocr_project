...
upload_folder= "C:\\Users\\gparu\\OneDrive\\Desktop\\Folder1"
...
def upload_image():
    ...
    try:
        ...
        return jsonify({'msg': 'Failed to open image file.'}), 500
    
    try:
        inpaint_text, translation = text_extraction(filepath, lang)
    except:
        return jsonify({'msg': 'Something Went Wrong, Please Try Again'}), 500'''
    inpainttext, translation = text_extraction(filepath, lang)
    print(translation)

    return {'inpaint': inpainttext, 'translation': translation, "status": "success"}
    return send_file(inpainttext, mimetype='image/jpeg')
...
def put_text(path, final_list, source):
    ...
    font_files = {
    'hi': "C:\\Users\\gparu\\Downloads\\NirmalaB.ttf"
    ...
    img.save('C:\\Users\\gparu\\OneDrive\\Desktop\\Folder1\\out1.png')
    return 'C:\\Users\\gparu\\OneDrive\\Desktop\\Folder1\\out1.png'
...
#result = text_extraction('C:\\Users\\LENOVO\\Desktop\\New folder\\photo5.jpg', 'C:\\Users\\LENOVO\\Desktop\\New folder\\out.png', keras_ocr.pipeline.Pipeline(), 'hi')
#print(result)
